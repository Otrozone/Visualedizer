...
void initLeds() {
  ...
  */
  ...
  // This is a workaround for the FastLED library limitation with multiple strips.
  ledStrips[0] = new LedStripDvc(String("Strip_1"), DVC_NUM_LEDS_LIST[0]);
  ...
  ledStrips[1] = new LedStripDvc(String("Strip_2"), DVC_NUM_LEDS_LIST[1]);
  ...
  ledStrips[2] = new LedStripDvc(String("Strip_3"), DVC_NUM_LEDS_LIST[2]);
  ...
  ledStrips[3] = new LedStripDvc(String("Strip_4"), DVC_NUM_LEDS_LIST[3]);
  ...
  ledStrips[4] = new LedStripDvc(String("Strip_5"), DVC_NUM_LEDS_LIST[4]);
