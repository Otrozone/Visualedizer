...
// WS2815 use as WS2813
  ...
  constexpr int DVC_NUM_LEDS_LIST[] = {30, 30};
  constexpr uint16_t DVC_DATA_PIN_LIST[] = {2, 3};
  constexpr uint16_t DVC_LED_OFFSET_LIST[] = {137, 137};
  constexpr uint16_t DVC_LED_SHIFT_LIST[] = {0, 0};
  // constexpr int DVC_NUM_LEDS_LIST[] = {274};
  // constexpr uint16_t DVC_DATA_PIN_LIST[] = {3};
  #define DVC_STRIP_COUNT 2 //sizeof(DVC_NUM_LEDS_LIST) / sizeof(DVC_NUM_LEDS_LIST[0]);
